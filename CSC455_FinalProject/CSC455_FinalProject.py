...
print('''This python script (movies.py) will be used for creating the 3NF database movies.db. The following output will describe the actions that the script is running in order to create the database, as well as some analysis regarding the queries used to analyze the database. Functions which create and populate the tables within the database are defined at the start of the script.
